...
{	
	...
	protected:
		// Map is constructed by GridNode
		uint8_t * data;  // point to map data, to represent the state of each grid
		GridNodePtr *** GridNodeMap;  // 3D pointer, easier to repersent 3D grid map
